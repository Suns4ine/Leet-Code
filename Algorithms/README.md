# Algorithms
![Algorithms](https://img.shields.io/badge/Problems-248_Complete-orange.svg) 

##### Easy 🤓  ![Algorithms](https://img.shields.io/badge/Problems-163_Complete-darkgreen.svg) 
...
- [x] [Next Greater Element I](Easy/Next-Greater-Element-I.swift)
- [x] [Word Pattern](Easy/Word-Pattern.swift)
- [x] [Detect Capital](Easy/Detect-Capital.swift)
- [x] [Delete Columns to Make Sorted](Easy/Delete-Columns-to-Make-Sorted.swift)
- [x] [Confusing Number](Easy/Confusing-Number.swift)
- [x] [Find Nearest Point That Has the Same X or Y Coordinate](Easy/Find-Nearest-Point-That-Has-the-Same-X-or-Y-Coordinate.swift)
- [x] [Binary Tree Preorder Traversal](Easy/Binary-Tree-Preorder-Traversal.swift)
- [x] [Check If It Is a Straight Line](Easy/Check-If-It-Is-a-Straight-Line.swift)
- [x] [N-ary Tree Preorder Traversal](Easy/N-ary-Tree-Preorder-Traversal.swift)
- [x] [Same Tree](Easy/Same-Tree.swift)
- [x] [Richest Customer Wealth](Easy/Richest-Customer-Wealth.swift)
- [x] [Reshape the Matrix](Easy/Reshape-the-Matrix.swift)
- [x] [Verifying an Alien Dictionary](Easy/Verifying-an-Alien-Dictionary.swift)
- [x] [Convert Binary Number in a Linked List to Integer](Easy/Convert-Binary-Number-in-a-Linked-List-to-Integer.swift)
- [x] [Sum of Left Leaves](Easy/Sum-of-Left-Leaves.swift)
...
- [x] [Longest Common Subsequence](Medium/Longest-Common-Subsequence.swift)
- [x] [Minimum Genetic Mutation](Medium/Minimum-Genetic-Mutation.swift)
- [x] [Minimum Rounds to Complete All Tasks](Medium/Minimum-Rounds-to-Complete-All-Tasks.swift)
- [x] [Minimum Number of Arrows to Burst Balloons](Medium/Minimum-Number-of-Arrows-to-Burst-Balloons.swift)
- [x] [Maximum Ice Cream Bars](Medium/Maximum-Ice-Cream-Bars.swift)
- [x] [Gas Station](Medium/Gas-Station.swift)
- [x] [Minimum Health to Beat Game](Medium/Minimum-Health-to-Beat-Game.swift)
- [x] [Minimum Time to Collect All Apples in a Tree](Medium/Minimum-Time-to-Collect-All-Apples-in-a-Tree.swift)
- [x] [Number of Nodes in the Sub-Tree With the Same Label](Medium/Number-of-Nodes-in-the-Sub-Tree-With-the-Same-Label.swift)
- [x] [Lexicographically Smallest Equivalent String](Medium/Lexicographically-Smallest-Equivalent-String.swift)
- [x] [Find the Index of the Large Integer](Medium/Find-the-Index-of-the-Large-Integer.swift)
- [x] [Flip String to Monotone Increasing](Medium/Flip-String-to-Monotone-Increasing.swift)
- [x] [Maximum Sum Circular Subarray](Medium/Maximum-Sum-Circular-Subarray.swift)
- [x] [Subarray Sums Divisible by K](Medium/Subarray-Sums-Divisible-by-K.swift)
- [x] [Non-decreasing Subsequences](Medium/Non-decreasing-Subsequences.swift)
- [x] [Restore IP Addresses](Medium/Restore-IP-Addresses.swift)

##### Hard 🥺  ![Algorithms](https://img.shields.io/badge/Problems-12_Complete-darkgreen.svg) 
...
- [x] [Basic Calculator](Hard/Basic-Calculator.swift)
